...
from .models import Order, OrderItem,Copon
...
class CartAddView(PermissionRequiredMixin,View):
	permission_required = 'oders.add_oder'
...
class OrderDtailView(LoginRequiredMixin, View):
...
class CouponApplyView(LoginRequiredMixin,View):
	...
	def post(self, request, order_id):
		...
		if form.is_valid():
			...
			try:
				coupon = Copon.objects.get(code__exact=code, valid_from__lte=now, valid_to__gte=now, active=True)
